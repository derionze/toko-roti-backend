...
const promo_seeder_service_1 = require("./promo.seeder.service");
let PromoModule = class PromoModule {
};
exports.PromoModule = PromoModule;
exports.PromoModule = PromoModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([promo_entity_1.PromoEntity])],
        providers: [promo_service_1.PromoService, promo_seeder_service_1.PromoSeeder],
